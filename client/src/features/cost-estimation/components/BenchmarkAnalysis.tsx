          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-lg border p-4">
              <div className="flex items-center justify-between">
                <span className="font-semibold text-slate-900">Our Professional Estimate</span>
            ...
            <AIResultBox
              ...
              content={analysis}
              isLoading={getAnalysisMutation.isPending}
              showCopyButton={true}
            />
            
            {!analysis && !getAnalysisMutation.isPending && (
