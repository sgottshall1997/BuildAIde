          ...
          <CardContent className="space-y-6">
            <div className="space-y-4">
              <Button 
                ...
                className="w-full h-12 bg-white hover:bg-gray-50 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-white border border-gray-300 dark:border-gray-600 font-medium flex items-center justify-center space-x-3"
                variant="outline"
              >
